...
public class IncidentAnalyzer {
     ...
     */
    public IncidentAnalyzer(List<SupportTicket> incidents) throws NullPointerException {
       //TODO - implement this constructor
        this.incidents = List.copyOf(Objects.requireNonNull(incidents, "tickets cannot be null"));
    }
    ...
    public List<SupportTicket> getCriticalOpenIncidents() {
        ...
        return List.copyOf(incidents.stream()
                .filter(i -> !i.resolved() && i.priority() == Priority.HIGH)
                .toList());
    }
}
